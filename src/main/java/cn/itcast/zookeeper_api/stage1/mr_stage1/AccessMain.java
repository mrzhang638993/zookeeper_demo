...
public class AccessMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        orderJob.setMapOutputKeyClass(AccessLogBean.class);
        ...
        TextOutputFormat.setOutputPath(orderJob, new Path("file:///F:\\works\\hadoop1\\zookeeper-demo\\src\\main\\java\\cn\\itcast\\zookeeper_api\\stage1\\data\\output"));
