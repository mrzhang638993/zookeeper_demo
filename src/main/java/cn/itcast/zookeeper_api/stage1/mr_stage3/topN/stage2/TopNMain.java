...
public class TopNMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        TextInputFormat.addInputPath(orderJob, new Path("file:///F:\\works\\hadoop1\\zookeeper-demo\\src\\main\\java\\cn\\itcast\\zookeeper_api\\stage1\\mr_stage3\\topN\\output"));
        //  设置mapper极段的参数
        ...
        orderJob.setReducerClass(TopNReducer.class);
        orderJob.setOutputKeyClass(TopNBean.class);
