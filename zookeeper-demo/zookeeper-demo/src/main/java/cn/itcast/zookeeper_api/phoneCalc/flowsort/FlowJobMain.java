...
public class FlowJobMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        TextOutputFormat.setOutputPath(flowSortJobMain, new Path("file:///E:\\BaiduNetdiskDownload\\zookeeper\\day02\\day02\\代码\\day02_zookeeper_api_demo\\src\\main\\java\\cn\\itcast\\zookeeper_api\\phoneCalc\\output1\\"));
