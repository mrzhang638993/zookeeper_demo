...
public class OrderMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        MySelfInput.addInputPath(orderJob, new Path("file:///E:\\BaiduNetdiskDownload\\zookeeper\\day02\\day02\\code\\day02_zookeeper_api_demo\\src\\main\\java\\cn\\itcast\\zookeeper_api\\topn\\input\\orders.txt"));
        //  设置mapper极段的参数
